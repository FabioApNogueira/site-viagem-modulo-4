 ...
 <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="compra-edit?id=${d.id}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="compra-delete?id=${d.id}" onclick="return confirm('Deseja excluir ${d.data}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
